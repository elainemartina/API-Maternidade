...
namespace MaternidadeAPI.Migrations
{
    ...
    [Migration("20230823013503_InitialMigration")]
            ...
            modelBuilder.Entity("MaternidadeAPI.Models.RNModel", b =>
                {
                    ...
                    b.HasOne("MaternidadeAPI.Models.MãeModel", null)
                        .WithMany("Filhos")
                        .HasForeignKey("MãeModelId");
